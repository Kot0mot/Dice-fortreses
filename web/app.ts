...
import { createInitialV2Match, tryPlaceNode, tryPlaceBeam, tryPlaceBuilding, tryUpgradeBuilding, tryRepairBuilding, tryRepairAll, tryDeleteBuilding, tryDeleteBeam, type V2MatchState } from "../src/matchState.js";
import { V2_GRID_WIDTH, V2_GRID_HEIGHT } from "../src/constants.js";
import { BEAM_MATERIALS, type BeamMaterialId } from "../src/mapTypes.js";
import { rollInitialDice, applyDiceResults } from "../src/diceSystems.js";
import type { RolledDieResult } from "../src/customDie.js";
import { performCollapse, calculateLoads } from "../src/physics.js";
import { fireWeapon, isWithinFiringCone, type FiringResult } from "../src/combat.js";
import { runAiTurn, type AiDifficulty } from "../src/ai.js";
import { V2_CAMPAIGN_STAGES, createInitialCampaign, applyCampaignPerks, getRandomPerkOptions, type CampaignState, CAMPAIGN_PERKS } from "../src/campaign.js";
import { BUILDING_CATALOG } from "../src/catalog.js";
...
// --- Auto-mount for standalone app ---
window.addEventListener("DOMContentLoaded", () => {
    const root = document.getElementById("v2-app-root");
    if (root) {
        mountV2Sandbox(root, { seed: Math.floor(Date.now()), onBack: () => { window.location.reload(); } });
    }
});
